...
from trackmaniarl.core.contracts import EnvironmentFactory, FeaturePipeline, Policy
from trackmaniarl.core.spec import EvaluationSuiteSpec
from trackmaniarl.experiments.evaluation import EvaluationResult, aggregate_results
from trackmaniarl.trackmania.diagnostics import ProgressBinDiagnostics, aggregate_progress_bins
        ...
        *,
        ...
        try:
            ...
            for _ in range(self.max_episode_steps):
                ...
                diagnostics.record(
                    float(info.get("progress_pct", progress_pct)), action, policy, info
                )
                prepared = self.feature_pipeline.transform_observation(observation)
