...
CHECKPOINT_PATH = r"D:\cp\exp0"  # r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\chk\exp0"
DATASET_PATH = r"D:\data2020"  # r"HOME_REDACTED\Desktop\git\tmrl\data"
ACT_IN_OBS = True
BENCHMARK = False
...
class TrainerInterface:
    ...
    def __init__(self,
                 redis_ip=None,
                 model_path=r'D:/cp/weights/expt.pth'): # r'HOME_REDACTED/Desktop/git/tmrl/checkpoint/weights/expt.pth'):
        self.__buffer_lock = Lock()
        self.__weights_lock = Lock()
        self.__weights = None
        self.__buffer = Buffer()
...
def main(args):
    ...
    if redis:
        ...
        rw = RolloutWorker(env_id="gym_tmrl:gym-tmrl-v0",
                           ...
                           model_path=MODEL_PATH_WORKER)
                           # model_path = r"HOME_REDACTED/Desktop/git/tmrl/checkpoint/weights/expt.pth")
        while True:
