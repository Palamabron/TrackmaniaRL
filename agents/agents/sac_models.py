...
if __name__ == "__main__":
    ...
    Sac_tm = partial(
        ...
        Agent=partial(Agent,
                      path_loc=r"HOME_REDACTED/Desktop/git/tmrl/data/",  # dataset
                      imgs_obs=4,
                      device='cpu',
    ...
    run_wandb_tm(None, None, None, run_cls=Sac_tm, checkpoint_path=r'HOME_REDACTED/Desktop/git/tmrl/checkpoint/chk/exp')
    #run(Sac_tm, checkpoint_path=r"HOME_REDACTED/Desktop/git/tmrl/checkpoint/exp")  # checkpoint
