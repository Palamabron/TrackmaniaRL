...
SDIST_REQUIRED_PATHS = frozenset(
    {
        ...
        "docs/assets/trackmaniarl-neural-flow.gif",
        "docs/neural-flow-media.md",
        "docs/activation-film.md",
        "docs/reviews/1.2.0-release-review.md",
        "scripts/distribution_privacy.py",
        ".env-example",
