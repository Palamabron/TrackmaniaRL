...
![TrackmaniaRL logo](https://raw.githubusercontent.com/Palamabron/TrackmaniaRL/v1.2.7/docs/assets/trackmaniarl-logo.png)
...
Version 1.2.7 requires Python 3.12 and uses RunSpec 2.0 and checkpoint schema 2.0.
...
```powershell
uv tool install "trackmaniarl==1.2.7"
...
```powershell
uv tool install path\to\trackmaniarl-1.2.7-py3-none-any.whl
```
...
a compatible PyTorch build. See [platform and performance guidance](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/performance.md).

## Neural inference in motion

![Full drive alongside road, car and context branches, residual blocks, action values and changing steering and pedal controls](https://raw.githubusercontent.com/Palamabron/TrackmaniaRL/v1.2.7/docs/assets/trackmaniarl-neural-flow.gif)
...
See [the model and recording explanation](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/docs/activation-film.md) for provenance,
the five-attempt film series and [GIF reproduction](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/docs/neural-flow-media.md).
...
[Trackmania setup](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/trackmania.md).
...
with the UID printed by `track check`. See [examples/own-map.yaml](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/examples/own-map.yaml)
...
More detail: [evaluation architecture](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/docs/library-architecture.md#checkpoints-and-evaluation),
[recording](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/docs/recording.md) and [troubleshooting](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/docs/troubleshooting.md).

## Documentation

Start with the [1.2.7 reading guide](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/README.md) for how the components fit
together and the setup-to-evaluation workflow.

- [Configuration](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/configuration.md)
- [Algorithms and supported combinations](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/algorithms.md)
- [Camera vision and PPO](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/vision.md)
- [Metrics and observability](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/observability.md)
- [Platforms and performance](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/performance.md)
- [Model, observations, actions and evaluation](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/docs/library-architecture.md)
- [Neural activation film and repeatable export](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/docs/activation-film.md)
- [Reward function](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/docs/reward-function.md)
- [Demonstrations and recovery](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/imitation-learning.md)
- [Replay and sequences](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/replay-and-sequences.md)
- [Distributed runtime](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/architecture.md)
- [Supported features and contracts](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/docs/support-status.md)
- [Troubleshooting](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/docs/troubleshooting.md)
- [Python API](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/sdk.md)
...
`run-ppo-vision.yaml`. See [camera vision and PPO](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/readme/vision.md) for setup.
...
TrackmaniaRL is released under the [MIT license](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/LICENSE). It originated from TMRL.
Attribution is in [NOTICE](https://github.com/Palamabron/TrackmaniaRL/blob/v1.2.7/NOTICE). It is not affiliated with Ubisoft or Nadeo.
