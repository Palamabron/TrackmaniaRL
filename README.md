...
Version 1.2.4 requires Python 3.12 and uses RunSpec 2.0 and checkpoint schema 2.0.
...
```powershell
uv tool install "trackmaniarl==1.2.4"
...
```powershell
uv tool install path\to\trackmaniarl-1.2.4-py3-none-any.whl
```
...
Start with the [1.2.4 reading guide](readme/README.md) for how the components fit
