...
# MODEL_PATH_WORKER = r"D:\cp\weights\exp.pth" if PRAGMA_EDOUARD_YANN else r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\weights\exp.pth"
# MODEL_PATH_TRAINER = r"D:\cp\weights\expt.pth" if PRAGMA_EDOUARD_YANN else r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\weights\expt.pth"
# CHECKPOINT_PATH = r"D:\cp\exp0" if PRAGMA_EDOUARD_YANN else r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\chk\exp0"
# DATASET_PATH = r"D:\data2020" if PRAGMA_EDOUARD_YANN else r"HOME_REDACTED\Desktop\git\tmrl\data"
# REWARD_PATH = r"D:\data2020reward\reward.pkl" if PRAGMA_EDOUARD_YANN else r"HOME_REDACTED/Desktop/git/tmrl/tm20reward/reward.pkl"
...
MODEL_PATH_WORKER = r"HOME_REDACTED/scratch/base_tmrl/data/exp.pth"
REWARD_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/reward.pkl"

# WANDB: =======================================================

WANDB_RUN_ID = "SAC_tm20_test_cc_1"
WANDB_PROJECT = "tmrl"
