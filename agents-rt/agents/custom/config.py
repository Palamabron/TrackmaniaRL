...
if PRAGMA_EDOUARD_YANN_CC == 2:  # Compute Canada
    ...
    MODEL_PATH_WORKER = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\weights\exp.pth"
    MODEL_PATH_TRAINER = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\weights\expt.pth"
    CHECKPOINT_PATH = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\chk\exp0"
