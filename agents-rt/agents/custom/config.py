...
if PRAGMA_EDOUARD_YANN_CC == 2:  # Compute Canada
    ...
    MODEL_PATH_WORKER = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\weights\4lidar_new_2_act_0.pth"
    MODEL_PATH_TRAINER = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\weights\4lidar_new_2_act_0_t.pth"
    CHECKPOINT_PATH = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\chk\4lidar_new_2_act_0"
    DATASET_PATH = r"HOME_REDACTED\Desktop\git\tmrl\data"
    REWARD_PATH = r"HOME_REDACTED/Desktop/git/tmrl/tm20reward/reward.pkl"

# WANDB: =======================================================

WANDB_RUN_ID = "SAC_tm20_test_yann_4lidar_new_2_act_0"
WANDB_PROJECT = "tmrl"
