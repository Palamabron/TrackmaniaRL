...
if PRAGMA_EDOUARD_YANN_CC == 2:  # Compute Canada
    ...
    MODEL_PATH_TRAINER = r"HOME_REDACTED/scratch/base_tmrl/data/expt3.pth"
    CHECKPOINT_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/exp3"
    DATASET_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/dataset"
    REWARD_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/reward.pkl"
    MODEL_PATH_WORKER = r"HOME_REDACTED/scratch/base_tmrl/data/exp3.pth"
