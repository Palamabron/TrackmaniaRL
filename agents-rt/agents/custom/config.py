...
if PRAGMA_EDOUARD_YANN_CC == 2:  # Compute Canada
    # MODEL_PATH_TRAINER = r"HOME_REDACTED/scratch/base_tmrl/data/expt.pth"
    # CHECKPOINT_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/exp0"
    MODEL_PATH_TRAINER = r"HOME_REDACTED/scratch/base_tmrl/data/t_imgs_1.pth"
    CHECKPOINT_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/imgs_1"
    DATASET_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/dataset"
    REWARD_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/reward.pkl"
    MODEL_PATH_WORKER = r"HOME_REDACTED/scratch/base_tmrl/data/imgs_1.pth"
    ...
    MODEL_PATH_WORKER = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\weights\4lidar_14.pth"
    MODEL_PATH_TRAINER = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\weights\4lidar_14_t.pth"
    CHECKPOINT_PATH = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\chk\4lidar_14"
    DATASET_PATH = r"HOME_REDACTED\Desktop\git\tmrl\data"
    REWARD_PATH = r"HOME_REDACTED/Desktop/git/tmrl/tm20reward/reward.pkl"

# WANDB: =======================================================

WANDB_RUN_ID = "SAC_tm20_test_yann_4lidar_014"
WANDB_PROJECT = "tmrl"
...
if CONFIG_COGNIFLY:
    ...
    if PRAGMA_EDOUARD_YANN_CC == 0:  # Yann  # TODO: CC
        MODEL_PATH_WORKER = r"HOME_REDACTED/Desktop/git/projets_perso/tmrl_cognifly_data/expcgn.pth"
        MODEL_PATH_TRAINER = r"HOME_REDACTED/Desktop/git/projets_perso/tmrl_cognifly_data/expcgnt.pth"
        CHECKPOINT_PATH = r"HOME_REDACTED/Desktop/git/projets_perso/tmrl_cognifly_data/expcgn0"
