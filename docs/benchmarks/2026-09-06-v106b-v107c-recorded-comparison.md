...
- `HOME_REDACTED\Videos\Captures\TrackmaniaRL-benchmark-20260906-v106b-v107c.mp4`
  - 35:18, approximately 2.81 GB
  - contains V106B, the visible invalid transition/replay interval, and the first valid V107C block
- `HOME_REDACTED\Videos\Captures\TrackmaniaRL-benchmark-20260906-v107c-continuation.mp4`
