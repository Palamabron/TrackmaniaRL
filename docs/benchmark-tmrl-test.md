# IQN + lidar benchmark: `tmrl-test`, version 1
...
TrackMania installation and the `tmrl-test` map.
...
- Acceptance: exactly 20 `tmrl-test` trials, at least 18 completed runs, median
