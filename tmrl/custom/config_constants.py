...
if PRAGMA_EDOUARD_YANN_CC == 2:  # Override some of these for Compute Canada
    if PRAGMA_SERVER_ON_EDOUARD_YANN == 1:  # Edouard
        MODEL_PATH_TRAINER = r"HOME_REDACTED/scratch/base_tmrl_edouard/data/SAC_4_LIDAR_Edouard_t.pth"
        CHECKPOINT_PATH = r"HOME_REDACTED/scratch/base_tmrl_edouard/data/SAC_4_LIDAR_Edouard"
        REWARD_PATH = r"HOME_REDACTED/scratch/base_tmrl_edouard/data/reward.pkl"
    else:  # Yann
        MODEL_PATH_TRAINER = r"HOME_REDACTED/scratch/base_tmrl/data/SAC_4_LIDAR_Yann_1_t.pth"
        CHECKPOINT_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/SAC_4_LIDAR_Yann_1"
