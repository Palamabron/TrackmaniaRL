...
RUN_NAME = "SAC_4_LIDAR_Edouard_tiny_road_3_3080"  # Yann en cours: "SAC_4_LIDAR_Yann_old_map_new_code_04"
...
LIDAR_BLACK_THRESHOLD = [70, 70, 70]  # [55, 55, 55] FOR BASIC ROAD
...
if PRAGMA_EDOUARD_YANN_CC == 2:  # Override some of these for Compute Canada
    if PRAGMA_SERVER_ON_EDOUARD_YANN == 1:  # Edouard
        MODEL_PATH_TRAINER = r"HOME_REDACTED/scratch/base_tmrl_edouard/data/" + (RUN_NAME + "_t.pth")
        CHECKPOINT_PATH = r"HOME_REDACTED/scratch/base_tmrl_edouard/data/" + RUN_NAME
        REWARD_PATH = r"HOME_REDACTED/scratch/base_tmrl_edouard/data/reward.pkl"
    else:  # Yann
        MODEL_PATH_TRAINER = r"HOME_REDACTED/scratch/base_tmrl/data/" + (RUN_NAME + "_t.pth")
        CHECKPOINT_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/" + RUN_NAME
    ...
    MODEL_PATH_TRAINER = r"HOME_REDACTED/base_tmrl/data/" + (RUN_NAME + "_t.pth")
    CHECKPOINT_PATH = r"HOME_REDACTED/base_tmrl/data/" + RUN_NAME
    REWARD_PATH = r"HOME_REDACTED/base_tmrl/data/reward.pkl"
