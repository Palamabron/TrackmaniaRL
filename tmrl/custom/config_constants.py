...
if PRAGMA_EDOUARD_YANN_CC == 2:  # Override some of these for Compute Canada
    MODEL_PATH_TRAINER = r"HOME_REDACTED/scratch/base_tmrl/data/SAC_4_LIDAR_Edouard_t.pth"
    CHECKPOINT_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/SAC_4_LIDAR_Edouard"
