...
RUN_NAME = "SACv1_SPINUP_4_LIDAR_pretrained_test_8"
...
if PRAGMA_EDOUARD_YANN_CC == 1:  # Override some of these for Compute Canada
    ...
    MODEL_PATH_TRAINER = r"HOME_REDACTED/tmrl/data/" + (RUN_NAME + "_t.pth")
    CHECKPOINT_PATH = r"HOME_REDACTED/tmrl/data/" + RUN_NAME
    REWARD_PATH = r"HOME_REDACTED/tmrl/data/reward.pkl"
