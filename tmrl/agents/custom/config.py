...
if PRAGMA_EDOUARD_YANN_CC == 2:  # Compute Canada
    MODEL_PATH_TRAINER = r"HOME_REDACTED/scratch/base_tmrl/data/4imgs_new_0_t.pth"
    CHECKPOINT_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/4imgs_new_0"
    DATASET_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/dataset"
    REWARD_PATH = r"HOME_REDACTED/scratch/base_tmrl/data/reward.pkl"
    MODEL_PATH_WORKER = r"HOME_REDACTED/scratch/base_tmrl/data/4imgs_new_0.pth"
    ...
    MODEL_PATH_WORKER = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\weights\4imgs_new_0.pth"
    MODEL_PATH_TRAINER = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\weights\4imgs_new_0_t.pth"
    CHECKPOINT_PATH = r"HOME_REDACTED\Desktop\git\tmrl\checkpoint\chk\4imgs_new_0"
