...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', '--record-episode', dest='record_episode', action='store_true', help='utility to record an episode to store it in replay buffer in TM20')
    parser.add_argument('--check-environment', dest='check_env', action='store_true', help='utility to check the environment')
    parser.add_argument('--wandb', dest='wandb', action='store_true', help='(use with --trainer) log results on Weights and Biases')
