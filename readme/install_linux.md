...
- When the installer asks you where it should install OpenPlanet for Trackmania, select the file where Trackmania is installed. On Steam, it is something like `HOME_REDACTED/.steam/steam/steamapps/common/Trackmania`.
...
```bash
cd ~/.steam/steam/steamapps/compatdata/xxxxxxx/pfx/drive_cHOME_REDACTED
```
