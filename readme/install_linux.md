...
- When the installer asks you where it should install Trackmania, select the file where Trackmania is installed. On Steam, it is something like `HOME_REDACTED/.steam/steam/steamapps/common/Trackmania`.
